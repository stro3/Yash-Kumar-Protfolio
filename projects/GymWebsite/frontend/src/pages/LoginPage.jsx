      ...
      <div className="relative max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-3 text-gray-400">
            ...
            <Link to="/signup" className="font-medium text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400 hover:from-blue-300 hover:to-cyan-300">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  type="email"
                  required
                  className="mt-2 block w-full px-4 py-3 bg-gray-700/50 border border-gray-600 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
